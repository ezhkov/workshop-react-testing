...
) is a fictional character in the Mario video
...
) is a fictional character featured in video games and related media
...
(
      ...
      <TabPanel>
        <p>
          ...
          {' '}
(
          <i>Japanese: キノピオ Hepburn: Kinopio</i>
) is a fictional character who primarily
